...
-- 	--Spawn on server only
	...
	-- if broadcastToClient then
        -- NetEvents:BroadcastLocal('SpawnBlueprint', uniqueString, partitionGuid, blueprintPrimaryInstanceGuid, newLinearTransform, variationNameHash)
	-- end

	local params = EntityCreationParams()
	params.transform = newLinearTransform
	params.variationNameHash = variationNameHash
	params.networked = objectBlueprint.needNetworkId == true
